...
\hypersetup{
    pdftitle={Logic and Proof},
    pdfauthor={Jeremy Avigad, Robert Y. Lewis, Floris van Doorn},
    colorlinks,
    linkcolor=Sepia,
...
\renewcommand{\maketitle}{
    ...
    \parbox[b]{0.73\textwidth}{%
      \vbox{%
        \vspace{\drop}
               ...
               {\bfseries
                 \href{https://github.com/leanprover/logic_and_proof/commit/\gitHash}{Version \gitAbbrevHash},
  ...
  \par
  \noindent
  Copyright (c) 2016, Jeremy Avigad, Robert Y. Lewis, and Floris van Doorn. All rights reserved.
